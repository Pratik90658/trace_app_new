...
List<UserModel> UserUid = <UserModel>[];
...
class _SearchPageState extends State<SearchPage> with TickerProviderStateMixin {
                          ...
                          return Column(
                            ...
                            children: List.generate(tags.length, (index) {
                              return Column(
                                ...
                                children: [
                                  searchLives(
                                    liveFilter: tags[index]["uid"] ?? tags[index]["uid"],
  ...
  // Future<List<UserModel>> searchUsersByUid(String uid) async {
  //   QueryBuilder<UserModel> queryBuilder =
  //   QueryBuilder<UserModel>(UserModel.forQuery());
  //
  //   queryBuilder.whereContains(UserModel.keyUid, uid.toLowerCase(),
  //       caseSensitive: false);
  //
  ...
  //     print("Error searching users by UID: ${response.error}");
  //     return [];
  //   }
  // }
  ...
  Future<List<dynamic>?> _loadSearchUser(String? searchFilter,
    ...
    if (searchFilter != null) {
      queryBuilder.whereContains(
         UserModel.keyUid, searchFilter.toLowerCase(),
          caseSensitive: false);
    }
    ...
    queryBuilder.whereValueExists(UserModel.keyUid, true);
  ...
  Widget searchUser(String? userFilter, {int? limitUsers}) {
    ...
    if (userFilter != null) {
      ...
      queryBuilder.whereContains(UserModel.keyUid,userFilter, caseSensitive: false);
    }
